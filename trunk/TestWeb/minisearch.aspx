<%@ Page Language="C#" AutoEventWireup="true" CodeFile="minisearch.aspx.cs" Inherits="minisearch" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function PopWindow()
        {
           SetCookie("SearchWords",document.getElementById("txtSearch").Text); 
           var setting = GetCookie("Setting");
           var url = "settings.aspx";
           if(setting != undefined)
           {
              url += "?param=" + escape( setting);
           }
           var result=showModalDialog(url,"subpage","dialogWidth:560px;dialogHeight:300px;center:yes;help:no;resizable:no;status:no" );
           SetCookie("Setting",result);
        } 
    </script>
    <style type="text/css">
        .LargeTitle
...
<body style="text-align: center" onload="Init();" bgcolor="white">
    ...
    <div id="divTable" style="width: 400px; height: 100%;" >
                   ...
                   <table width="100%" height="100%" border="0" cellpadding="0" cellspacing ="0">
                       <tr height="35px" >
                          ...
                          <td width="30px" style="text-align:right">
                              <a id="HyperLink1" href="#" onclick="PopWindow()" style="display: inline-block; font-size: 9pt">设置</a>
                          </td>
                       </tr>
                       <tr height="20px" >
                       ...
                       <tr>
                          <td id="tdResult" runat="server" colspan="4" style="text-align: left" >
                          </td>
                       </tr>
                       <tr>
                           <td id="tdPageSet" runat="server" colspan="4">
                           </td>
                       </tr>
                   </table>
               </td>
