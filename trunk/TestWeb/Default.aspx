...
<body>
    ...
    <div style="text-align: center">
        <asp:Panel ID="Panel1" runat="server" Height="692px" Width="751px">
            ...
            <asp:TextBox ID="txtIP" runat="server" Height="15px" Width="151px">192.168.1.254</asp:TextBox><br />
            <asp:Label ID="Label2" runat="server" Text="使用索引："></asp:Label>
            <asp:TextBox ID="txtIndexName" runat="server">in_incr1,in_incr2</asp:TextBox><br />
